...
function QuoteCard() {
  ...
  const svgH = 200;
  const svgContent = [
    `<svg width="100%" viewBox="0 0 400 ${svgH}" xmlns="http://www.w3.org/2000/svg" style="display:block">`,
...
.btn:hover{background:#e8e8e8}.btn:active{transform:scale(.98)}
.btn-primary{background:#7DC242;color:#fff;border-color:#7DC242}.btn-primary:hover{background:#639922}
...
.badge-pending{background:#FFFBEB;color:#92400E}.badge-partial{background:#EFF6FF;color:#1D4ED8}
.badge-done{background:#F3FBE8;color:#3B6D11}.badge-overdue{background:#FEF2F2;color:#991B1B}
...
.g-overdue .group-pill{background:#FEF2F2;color:#991B1B}.g-today .group-pill{background:#FFFBEB;color:#92400E}
.g-upcoming .group-pill{background:#f0f0f0;color:#555}.g-done .group-pill{background:#F3FBE8;color:#3B6D11}
...
.pm-remarks-block .pm-detail-label{color:#92400E}.pm-remarks-block .pm-detail-val{color:#92400E}
...
.pm-plat-posted{background:#F3FBE8;border-color:#C0DD97}.pm-plat-pending{background:#FAFDF7}
